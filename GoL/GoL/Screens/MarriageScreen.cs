...
namespace GoL
{
    class MarriageScreen:GameScreen
    {
        ...
        public event EventHandler<PlayerIndexEventArgs> Confirm;
        #endregion

        #region Initializers
        public MarriageScreen(string message)
            : this(message, true)
        {
        }

        public MarriageScreen(string message, bool includeUsageText)
        {
        ...
        public override void HandleInput(InputState input)
        {
            ...
            if (input.isNewKeyPress(Keys.Space, ControllingPlayer, out playerIndex))
            {
                if (Confirm != null)
                {
                    Confirm(this, new PlayerIndexEventArgs(playerIndex));
                }
                ScreenExit();
            }
        }
