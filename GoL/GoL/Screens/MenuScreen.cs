...
//-----------------------------------------------------------------------------
//This was another part of a Microsoft template.
#endregion
...
namespace GoL
{
    ...
    abstract class MenuScreen : GameScreen
    {
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            {
                bool isSelected = Active && (i == selectedEntry);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 position = new Vector2(450, 400);
            ...
            // Draw the menu title.
            Vector2 titlePosition = new Vector2(GraphicsDeviceManager.DefaultBackBufferWidth/2, 80);
